...
import Pembayaran from './pembayaranSaya'
import Komisi from './komisiSaya'
    ...
    <View>
        <View style={{flexDirection:'row', justifyContent:'space-around', alignItems:'center', backgroundColor:'white', padding:10}}>
            <View style={{flexDirection:'row', alignItems:'center', width:'70%'}}>
                ...
                <Text style={{fontSize:16}}>Pembayaran Saya</Text>
            </View>
            <View style={{width:'25%'}}>
                {/* <TouchableOpacity>
...
function editAkun(props) {
    ...
    return (
        <Tab.Navigator tabBar={props => <MyTabBar {...props} />}>
            <Tab.Screen name="Pembarayaran" component={Pembayaran}/>
            <Tab.Screen name="Komisi" component={Komisi}/>
        </Tab.Navigator>
    );
}
