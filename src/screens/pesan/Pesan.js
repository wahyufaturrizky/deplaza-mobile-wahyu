...
function Pesan(props) {
  ...
  const [totalOngkir, setTotalOngkir] = useState(
  ...
  const handleChoosePhoto = async () => {
    ...
    ImagePicker.openPicker({
      ...
      setLoading(true);
      fetch(urlOrder + idOrder + '/pay-base', {
        method: 'POST',
        headers,
        body: formdata,
      })
      ...
      if (qtynow > 1) {
        if (qtynow > stock) {
          ...
          setQty(
            ...
            setTotalKomisi(komisiDasar * qtynow),
          );
          setTotalBiaya(
            hargaProduk * qtynow +
              totalOngkirNow +
          ...
          <View style={{padding: 10}}>
            ...
            <View
              ...
              <View>
                ...
                <Text style={{color: 'gray', fontSize: 12}}>
                  (Tunai yang Dikumpulkan dari Pelanggan)
                </Text>
              </View>
            ...
            <View
              ...
              <View style={{alignItems: 'flex-end'}}>
                <Text style={{fontSize: 12}}>
                  Rp. {formatRupiah(totalKomisi)} + Rp. {formatRupiah(margin)}
                </Text>
            ...
            <View
              ...
              <View
                ...
                <Picker
                  ...
                  onValueChange={(itemValue, itemIndex) =>
                    _setKecamatan(itemValue, itemIndex)
                  }>
                  <Picker.Item label={'Pilih Kecamatan'} value={'kosong'} />
                  {subdistricts.map((camat, i) => (
                    <Picker.Item
                      key={i}
                      label={camat.subdistrict_name}
                      value={camat.subdistrict_id}
                    />
                  ))}
                </Picker>
              </View>
