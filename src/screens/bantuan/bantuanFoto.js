...
import { Text, View, Image, ImageBackground, TouchableOpacity, Dimensions, Linking } from 'react-native';
...
function bantuanFoto(props) {
    ...
    const openCanva = () => {
        Linking.openURL("market://details?id=com.canva.editor&hl=en");
    }
           ...
           <Appbar params={props}/>
                ...
                <ScrollView>
                    ...
                    <View style={{alignItems:'center', flex:1}}>
                        ...
                        <View>
                            <TouchableOpacity onPress={() => openCanva()}>
